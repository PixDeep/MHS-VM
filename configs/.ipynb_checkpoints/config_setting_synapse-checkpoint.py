...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        'load_ckpt_path': None #'./pre_trained_weights/vmamba_small_e238_ema.pth',
    }
    
    if model_config['num_layers'] == 5:
        model_config['depths'] = [2,2,2,2,2]
        model_config['depths_decoder'] = [2,2,2,2,1]
        model_config['scanroute_dict_path'] = './scanroute_dict_5l_syn.pth'
        print('Layers:', model_config['num_layers'])
    else:
        model_config['depths'] = [2,2,2,2]
        model_config['depths_decoder'] = [2,2,2,1]
        model_config['scanroute_dict_path'] = './scanroute_dict_4l_syn.pth'
        print('Layers:', model_config['num_layers'])
        
    print('in config', model_config['depths'])
    ...
    #work_dir = 'results/vmunet_synapse_Wednesday_05_June_2024_07h_33m_24s/'

...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        'load_ckpt_path': None,
        'para_dict': {'head_num': 4, 'with_proj': True, 'gfu_t': 0.0} 
    }

    if model_config['num_layers'] == 5:
        model_config['depths'] = [2,2,2,2,2]
        model_config['depths_decoder'] = [2,2,2,2,1]
        model_config['route_dict_path'] = './scanroute_dict_5l.pth'
    else:
        model_config['depths'] = [2,2,2,2]
        model_config['depths_decoder'] = [2,2,2,1]
        model_config['route_dict_path'] = './scanroute_dict_4l.pth'

    
    datasets = 'isic18' 
    if datasets == 'isic18':
        model_config['para_dict']['gfu_t'] = 0.5
        data_path = './data/isic2018/'
    elif datasets == 'isic17':
        model_config['para_dict']['gfu_t'] = 0.0
